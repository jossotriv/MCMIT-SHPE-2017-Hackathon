...
<div class="w3-main w3-black" style="margin-left:300px">
  ...
  <footer class="w3-container w3-padding-32 w3-grey">  
    <div class="w3-row-padding w3-container w3-black">
        <div style="">
  <h1>Enter Information</h1>
  <form id = "register" action="" method="post" >
    <ul>
    <li>
      Address Inspected:<br>
      ...
      <input type="password" name="password" id = "password" ></li>
      <span id="result"></span>
      <li>Link to house information:<br>
      <input type="password" name="password" id = "password" ></li>
      <span id="result"></span>
      ...
      <li>Building Material:<br>
      <form action="/action_page.php">
      <select name="cars">
        <option value="volvo">Wood</option>
        <option value="saab">Metal</option>
        <option value="fiat">Brick</option>
        <option value="audi">Other</option>
      </select>
      <br><br>
      </form>
      <form action="getfile.php" method="post"><br>
      <h6><li>Type (or select) the Floor plan PDF:</li><input type="file" name="uploadFile">
      <input type="submit" value="Upload File">
      </form></h6>

      <input type="submit"><a href='index.php'><input type="button" name="cancel" value= "Cancel"></a>
